      ...
      .then((data) => {
        ...
        const houses = data.map((ev) => ({
          ...
          coverImageUrl: ev.coverImageUrl
            ? ev.coverImageUrl.startsWith("http")
              ? ev.coverImageUrl
              : "http://localhost:5254" + ev.coverImageUrl
            : "/placeholder.jpg",
        }));
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Giriş Tarihi */}
        <div className="flex flex-col items-start w-40">
          <label htmlFor="check-in" className="text-[black]">
            Giriş Tarihi
          </label>
          <input
            type="date"
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-2 py-1 bg-gray-200 rounded text-[#C99297]"
                  >
                    +
                  </button>
                </div>
        ...
        <button
          className="bg-[#C99297] text-white px-3 py-1 rounded hover:bg-[#906668] flex items-center gap-2"
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-3 text-sm mb-2 text-black">
                    <div className="flex items-center gap-1">
                      <FaBed /> {house.bedroomCount}
                    </div>
                    <div className="flex items-center gap-1">
                      <FaBath /> {house.bathroomCount}
                    </div>
                    <div className="flex items-center gap-1">
              ...
              <div className="p-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm mb-2">
                    <div className="flex items-center gap-1">
                      <FaBed /> {house.bedroomCount || house.beds} Yatak Odası
                    </div>
                    <div className="flex items-center gap-1">
                      <FaBath /> {house.bathroomCount || house.baths} Banyo
                    </div>
                    <div className="flex items-center gap-1">
                      <FaUserCircle /> {house.capacity} Kişi
                    </div>
                ...
                <div className="flex justify-between items-center">
                  <span className="font-bold">
                    ₺{house.pricePerNight || house.price}/gece
                  </span>
                  <span className="flex items-center gap-1 text-yellow-500">
                    <FaStar /> {house.averageRating}
                  </span>
